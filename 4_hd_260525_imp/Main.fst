------- OpenFAST v5.x INPUT FILE -----------------------------------------------
DLC Test by JHLEE
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
       9000   TMax            - Total run time (s)
...
"****.dat"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"****.dat"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"****.dat"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"InflowWind_Step.dat"         InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"SeaState.dat"                    SeaStFile       - Name of file containing sea state input parameters (quoted string) !"NRELOffshrBsline5MW_OC4DeepCwindSemi_HydroDyn.dat"   HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)   
"HydroDynR_woWAMIT_RedHullRedEle.dat"             HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"SubDyn_Floater+3rdTower(x)R.dat"                 SubFile         - Name of file containing sub-structural input parameters (quoted string)
"MoorDyn.dat"                     MooringFile     - Name of file containing mooring system input parameters (quoted string)
"unused"                          IceFile         - Name of file containing ice input parameters (quoted string)
"SoilDyn.dat"                     SoilFile        - Name of the file containing the SoilDyn input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
...
False         CalcSteady      - Calculate a steady-state periodic operating point before linearization? [unused if Linearize=False] (flag)
      ...
      0.001   TrimTol         - Tolerance for the rotational speed convergence [used only if CalcSteady=True] (-)
       0.01   TrimGain        - Proportional gain for the rotational speed error (>0) [used only if CalcSteady=True] (rad/(rad/s) for yaw or pitch; Nm/(rad/s) for torque)
         ...
         39, 40   LinTimes        - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
